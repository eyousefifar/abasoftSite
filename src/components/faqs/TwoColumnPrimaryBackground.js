...
const Faq = tw.div`select-none cursor-pointer border-b-2  transition-colors duration-300 py-6`;
...
export default ({
  ...
  description = "some questions about work at ABA SOFT.",
  faqs = [
    {
      question: "Programmers are problem solvers, does it mean we have to worry about managerial work too ?",
      answer:
        "No, it means we share the knowledge about goals and the product with everyone, and we value opinions on products from every one. when decided, we will just focus on their job."
    },
    {
      question: "Can You work remotely?",
      answer:
        "Due to the Pandemic, remote work is really appreciated."
    },
    {
      question: "?",
      answer:
  ...
  return (
    <PrimaryBackgroundContainer style={{backgroundColor: "#2e7d32"}}>
